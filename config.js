...
window.PEPE_CONFIG = {
  ...
  buy: 'https://www.stonkfun.xyz/token/CZ3qbW9qwENcoBfv5b4sNcbhvziWu4o2LbNP4BEibCHq',                      // custom buy link. Empty = pump.fun/coin/<mint>
  x: 'https://x.com/peepeestonks',  // X / Twitter link (icon next to Buy). Empty = hidden
